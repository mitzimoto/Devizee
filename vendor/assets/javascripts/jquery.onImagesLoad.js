        ...
        self.bindEvents = function($imgs, container, callback){
            if ($imgs.length === 0){ //no images were in selection. callback based on options
                ...
                $imgs.each(function(i){
                    ...
                    $(this).error(function(){
                        noimg = "/assets/photo-not-available.jpeg";
                        this.src = noimg;
                        this.orgSrc = noimg;
                        console.log(this);
                    })
                    ...
                    if (!$.browser.msie) {
                        this.src = this.orgSrc; //needed for potential cached images
                    }
                    else if (this.complete || this.complete === undefined){ this.src = this.orgSrc; }
                });
            }
        };
